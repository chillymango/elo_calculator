...
function AdminButtons() {
    ...
    const fetchPlayers = async () => {
        ...
        try {
            const response = await fetch('https://elo.alberthyang.com/api/players');
            if (!response.ok) {
    ...
    const handleAddPlayer = async () => {
        try {
            const response = await fetch('https://elo.alberthyang.com/api/add_player', {
                method: 'POST',
                headers: {
    ...
    const handleRecordMatch = async () => {
        try {
            const response = await fetch('https://elo.alberthyang.com/api/match', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    useEffect(() => {
      const checkAuthorization = async () => {
        ...
        try {
          const response = await fetch('https://elo.alberthyang.com/api/is_authorized', {
            headers: {
